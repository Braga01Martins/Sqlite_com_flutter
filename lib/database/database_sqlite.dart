...
class DatabaseSqLite {
  ...
  // Future<void> openConnection() async {
    ...
    return await openDatabase(
      ...
      //primeira vez qeu carrega o aplicativo
      ...
      //Será chamado sempre qeu houver uma alteração no version  incremental (1 -> 2)
      ...
      //Será chamado sempre qeu houver uma alteração no version para menos (2 -> 1)
